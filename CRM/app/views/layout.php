        ...
        <div class="sidebar col-md-3">
            <div class="d-flex flex-column flex-shrink-0 p-3 text-white bg-dark" style="min-height: 900px;">
                ...
                <ul class="nav nav-pills flex-column mb-auto">
                    ...
                    <li>
                        <a href="/<?= APP_BASE_PATH ?>/orders_cons" class="nav-link text-white <?= is_active('/' . APP_BASE_PATH . '/orders_cons') ?>">
                            <svg class="bi me-2" width="16" height="16"><use xlink:href="/<?= APP_BASE_PATH ?>/orders_cons"></use></svg>
                            Консультации
                        </a>
                    </li>
                    <li>
                        <a href="/<?= APP_BASE_PATH ?>/orders" class="nav-link text-white <?= is_active('/' . APP_BASE_PATH . '/orders') ?>">
                            <svg class="bi me-2" width="16" height="16"><use xlink:href="/<?= APP_BASE_PATH ?>/orders"></use></svg>
                            Сеансы
                        </a>
                    </li>
                </ul>
