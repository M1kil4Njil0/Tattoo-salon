...
<link rel="stylesheet" href="../css/Reviews.css" media="screen">
  ...
  <body data-path-to-root="./" data-include-products="false" class="u-body u-overlap u-overlap-contrast u-overlap-transparent u-xl-mode" data-lang="ru"><header class="u-align-center-sm u-align-center-xs u-clearfix u-header" id="sec-bdaf"><div class="u-clearfix u-sheet u-sheet-1">
...
<?php endif; ?>
    ...
    <section class="u-align-center u-black u-clearfix u-section-1" id="sec-d6fa">
      <div class="u-clearfix u-sheet u-sheet-1">
        <h2 class="u-text u-text-default u-text-1">Оставьте отзыв</h2>
        <div class="u-form u-form-1">
          <form onsubmit="location.reload();" action="" method="POST" class="u-clearfix u-form-spacing-10 u-form-vertical u-inner-form" style="padding: 10px">
          <input type="hidden" name="reviews">  
          <div class="u-form-group u-form-name u-label-none">
              <label for="name-3b9a" class="u-label">Имя</label>
              <input type="text" placeholder="Введите имя" id="name-3b9a" name="name" class="u-input u-input-rectangle" required="">
            </div>
            <div class="u-form-group u-form-message u-label-none">
              <label for="message-3b9a" class="u-label">Сообщение</label>
              <textarea placeholder="Введите отзыв" rows="4" cols="50" id="message-3b9a" name="message" class="u-input u-input-rectangle" required=""></textarea>
            </div>
            <div class="u-align-left u-form-group">
            <input type="submit" value="Отправить" class="u-active-white u-border-none u-btn u-btn-round u-button-style u-custom-color-2 u-hover-white u-radius-10 u-btn-1" >
            </div>
          </form>
          <?
            if (isset($_POST['reviews'])) {
              $sql = "INSERT INTO `reviews`(name, message) VALUES (?,?)";
    ...
    <section class="u-black u-clearfix u-section-2" id="sec-5439">
      <div class="u-clearfix u-sheet u-sheet-1">
        <div class="data-layout-selected u-clearfix u-expanded-width-md u-expanded-width-sm u-expanded-width-xs u-gutter-0 u-layout-wrap u-layout-wrap-1">
          <div class="u-layout">
            <div class="u-layout-row">
              <div class="u-align-center-sm u-align-center-xs u-align-left-lg u-align-left-md u-align-left-xl u-container-style u-layout-cell u-right-cell u-size-60 u-layout-cell-1">
                <div class="u-container-layout u-container-layout-1">
                  <p class="u-text u-text-1"><?=$review['message']?></p>
                  <h5 class="u-text u-text-2"><?=$review['name']?></h5>
                </div>
              </div>
            </div>
          </div>
    ...
    <footer class="u-align-center-md u-align-center-sm u-align-center-xs u-clearfix u-footer u-grey-80" id="sec-1fad"><div class="u-clearfix u-sheet u-sheet-1">
      <div class="menu">
        ...
        <ul>
          <li class="li_menu"><a href="../page/Contacts.php" class="u-active-none u-border-2 u-border-no-left u-border-no-right u-border-no-top u-border-white u-btn u-btn-rectangle u-button-style u-hover-none u-none u-btn-3">Отзывы </a></li>
